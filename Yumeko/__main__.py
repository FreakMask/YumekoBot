...
If you want to report any bugs or need any help with setting up Chrollo, reach us at Support"""
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[The Spider head is Alive now!!](https://telegra.ph/file/2b93614d9fa79934512ca.mp4)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
